...
Subtract11- 5
(115 6'
NotificationRetentionPeriod116 Q
)11Q R
;11R S
using33 
var33 
...
scope55 !
.55! "
ServiceProvider55" 1
.551 2
GetRequiredService552 D
<55D E
HealthAxisDbContext55E X
>55X Y
(55Y Z
)55Z [
;55[ \
...
catch11 
(11 &
OperationCanceledException11 -
ex11. 0
)110 1
when22 
(22 
...
;PP9 :
varRR )
affectedAvailabilityCacheKeysRR 1
=RR2 3
awaitSS .
"AutoCancelOverdueAppointmentsAsyncSS <
(SS< =
	dbContextTT !
,TT! "
todayUU 
...
ifXX 
(XX )
affectedAvailabilityCacheKeysXX 1
.XX1 2
CountXX2 7
>XX8 9
$numXX: ;
...
{YY 
awaitZZ -
!InvalidateAvailabilityCachesAsyncZZ ;
(ZZ; <
cache[[ 
,[[ )
affectedAvailabilityCacheKeys\\ 5
,\\5 6
cancellationToken]] )
)]]) *
;]]* +
...
{aa 
awaitbb /
#DeleteOldCancelledAppointmentsAsyncbb =
(bb= >
	dbContextcc !
,cc! "
todaydd 
...
>{{) *
>{{* +.
"AutoCancelOverdueAppointmentsAsync{{, N
({{N O
HealthAxisDbContext|| 
	dbContext||  )
,||) *
