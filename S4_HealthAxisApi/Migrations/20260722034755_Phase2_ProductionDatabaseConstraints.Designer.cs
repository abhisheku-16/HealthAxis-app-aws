...
namespace S4_HealthAxisApi.Migrations
{
    ...
    [Migration("20260722034755_Phase2_ProductionDatabaseConstraints")]
    partial class Phase2_ProductionDatabaseConstraints
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("S4_HealthAxisApi.Models.Appointment", b =>
                {
            ...
            modelBuilder.Entity("S4_HealthAxisApi.Models.HealthRecord", b =>
                {
            ...
            modelBuilder.Entity("S4_HealthAxisApi.Models.Notification", b =>
                {
            ...
            modelBuilder.Entity("S4_HealthAxisApi.Models.Patient", b =>
                {
                    b.Property<int>("PatientId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("S4_HealthAxisApi.Models.User", b =>
                {
            ...
            modelBuilder.Entity("S4_HealthAxisApi.Models.Appointment", b =>
                {
                    b.HasOne("S4_HealthAxisApi.Models.Doctor", "Doctor")
                        .WithMany("Appointments")
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("S4_HealthAxisApi.Models.Patient", "Patient")
                        .WithMany("Appointments")
            ...
            modelBuilder.Entity("S4_HealthAxisApi.Models.HealthRecord", b =>
                {
                    b.HasOne("S4_HealthAxisApi.Models.Appointment", "Appointment")
                        .WithOne("HealthRecord")
                        .HasForeignKey("S4_HealthAxisApi.Models.HealthRecord", "AppointmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
