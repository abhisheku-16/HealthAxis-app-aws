...
```powershell
git clone [https://github.com/](https://github.com/)<your-user-or-org>/<your-repo>.git
cd <your-repo>
...
New-Item -ItemType Directory -Path .\S4_HealthAxisApi\wwwroot\Blazor -Force
Copy-Item .\blazor-publish-temp\wwwroot\* .\S4_HealthAxisApi\wwwroot\Blazor -Recurse -Force
